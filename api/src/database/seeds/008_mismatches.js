...
export async function seed(knex) {
  ...
  const alice_bob = createMismatch("alice_agrees", "bob_disagrees", 85, 25, "high");
  ...
  const alice_carol = createMismatch("alice_agrees", "carol_moderate", 35, 22, "medium");
  ...
  const bob_carol = createMismatch("bob_disagrees", "carol_moderate", 45, 20, "medium");
  ...
  const david_alice = createMismatch("david_active", "alice_agrees", 22, 23, "medium");
  ...
  const david_bob = createMismatch("david_active", "bob_disagrees", 82, 24, "high");
  ...
  const frank_grace = createMismatch("frank_blocked", "grace_blocker", 28, 20, "medium");
  ...
  const jack_alice = createMismatch("jack_response_heavy", "alice_agrees", 18, 25, "high");
  ...
  const jack_bob = createMismatch("jack_response_heavy", "bob_disagrees", 88, 25, "high");
  ...
  const jack_carol = createMismatch("jack_response_heavy", "carol_moderate", 38, 24, "high");
  ...
  const karen_alice = createMismatch("karen_response_light", "alice_agrees", 25, 20, "low");

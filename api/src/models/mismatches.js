...
export async function sendRumbleRequest_model(requester_id, receiver_id, trx = db) {
...
export async function checkForPendingRumbleRequest_model(requester_id, receiver_id, trx = db) {

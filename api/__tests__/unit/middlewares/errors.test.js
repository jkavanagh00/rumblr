describe("errors middleware", () => {
  describe("validateBody", () => {
    ...
    test.todo(
      "attaches parsed data to req.validatedBody when schema validation succeeds",
    );
  ...
  describe("errorHandler", () => {
    ...
    test.todo(
      "maps each validation issue to field and message in response errors array",
    );
    ...
    test.todo(
      "defaults message to Internal Server Error when non-validation error has no message",
    );
  });
});

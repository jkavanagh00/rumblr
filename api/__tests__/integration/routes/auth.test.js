describe("auth integration routes", () => {
	describe("POST /api/auth/signup", () => {
		test.todo("returns 201 with accessToken and created user when payload is valid and unique");
		...
		test.todo("returns 500 when ACCESS_TOKEN_SECRET is missing during token creation");
	});

	describe("POST /api/auth/login", () => {
		test.todo("returns 200 with accessToken and public user fields for valid email credentials");
		test.todo("returns 200 with accessToken and public user fields for valid username credentials");

...
## Statements and Mismatches

1. Statements take the form of a statement which the user is prompted to respond to:
...
3. Users must answer a minimum of 20 statements in order to establish a baseline for comparison
   - 20 standard mandatory statements will be presented to each user during onboarding, ensuring a minimal overlap
...
5. A confidence score will be assigned based on the number of shared statements between each user, and mismatches with higher confidence scores will be listed before lower scores
